module.exports = (function() {
  ...
  function databot(input, output, context) {
    ...
    const mappingType = require(path.join(__dirname, path.join("lib", input.mappingType.serviceIdToLsoa)));
    ...
    if (input.sourceResource) {
      ...
      sourceStream = context.tdxApi.getRawFile(input.sourceResource.rawFile1);
    } else {
