...
const ageCalculator = require("../lib/people-each-gp-calculator");
const dataObj = {};
const saveObj = {};
...
describe("../lib/people-each-gp-calculator.js testing", () => {
  describe("age calculator testing for gp-ratio mapping", () => {
    _.forEach(testExcelArray, (jsonObj, index) => {
      if (index === 0) {
        it("should return saveObj as an object with 3 keys", () => {
          ageCalculator(jsonObj, dataObj, saveObj, index);
          return Object.keys(saveObj).should.have.lengthOf(3);
        });
      } else if (index === 1) {
        it("should return dataObj as an object with 3 keys", () => {
          ageCalculator(jsonObj, dataObj, saveObj, index);
