module.exports = (function() {
   ...
   */
  const tdxTypeArray = ["cty15cd-lsoa11cd", "ratio-mapping", "yearGroup-ageBand-mapping",
    "yearGroup-ageBand-each-lsoa-mapping", "ccg16cd-lsoa11cd", "schools-details", "school-behaviour"];
  const multipleFile = ["ratio-each-service", "schoolId-to-cty15cd"];
