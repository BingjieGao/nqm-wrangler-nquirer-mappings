module.exports = (function() {
  ...
  *
  * @param beginIndex - the offset column in raw csv file, it reads the number of
  * people each single age and gender registered in each GP
  *
  * @param maleIndex - the column in raw csv file represents number of people
  * registered in each GP who is male
  *
  * @param femaleIndex - the column in raw csv file represents number of people
  ...
  */
  ...
  const Wrangler = function(jsonObj, femaleObj, maleObj) {
    ...
    _.forEach(allAgebands, (ageBand, i) => {
      ...
      //   ageBand: ageBand,
      //   serviceId: serviceId,
      //   ratio: gender === "female" ? femaleObj[ageBand][serviceId] : maleObj[ageBand][serviceId],
      //   serviceRatio: {},
      // };
