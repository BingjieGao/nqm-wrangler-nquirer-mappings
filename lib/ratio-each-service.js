module.exports = (function() {
  ...
  Wrangler.prototype.wrangler = function(jsonObj, mappingString, rowIndex) {
    ...
    populationEachGP(jsonObj, this.objectOfEach, this.saveObject, this.gender, rowIndex, this.input, this.output);
    populationTotalEachLsoa(jsonObj, this.objectOftotal, this.saveObject, this.gender);
  };

  Wrangler.prototype.finish = function() {
    _.forEach(this.objectOfEach, (value, key) => {
      const totalPeople = this.objectOfEach[key];
      const rObj = {
        "area_id": key,
        "gender": this.gender,
        "ratios": {},
